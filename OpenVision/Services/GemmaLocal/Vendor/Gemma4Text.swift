...
//  gemma4
//
//  VENDORED — MIT License. Source: https://github.com/vdthatte/gemma4-ios
//  Copyright (c) 2026 Vidyadhar Thatte. See LICENSE-gemma4-ios in this folder.
//  Unmodified Gemma 4 text-model port for mlx-swift-lm, used by GemmaLocalService.
//
